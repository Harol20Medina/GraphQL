...
export declare function createSchemaManagerHostFromTSGqlPluginConfig(pluginConfig: Omit<TsGraphQLPluginConfigOptions, 'typegen'>, prjRootPath: string, debug?: (msg: string) => void): SystemSchemaManagerHost;
